...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
    )  # BIWI_70_30_train.npz #300W_LP/files.txt
    parser.add_argument(
        "--output_string",
        dest="output_string",
...
if __name__ == "__main__":
    ...
    summary_name = "{}_{}_bs{}".format("SixDRepNet", int(time.time()), args.batch_size)
    ...
    train_loader = torch.utils.data.DataLoader(
        dataset=pose_dataset, batch_size=batch_size, shuffle=True, num_workers=4
    )
