# Source: https://github.com/Hyuto/yolo-nas-onnx/tree/master/yolo-nas-py Inspired from:
# https://github.com/Deci-AI/super-gradients/blob/3.1.1/src/super_gradients/training/processing/processing.py
